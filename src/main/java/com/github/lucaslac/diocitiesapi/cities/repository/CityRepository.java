package com.github.lucaslac.diocitiesapi.cities.repository;

import com.github.lucaslac.diocitiesapi.cities.City;
...
public interface CityRepository extends JpaRepository<City, Long> {
    ...
    String QUERY2 = "SELECT earth_distance(ll_to_earth(?1,?2), ll_to_earth(?3,?4)) as distance";
